...
initialize_solution([H|T], Lingua, NProfessores, Professores, ProfAvailable):-
	...
	%%%%%% TABELAS AUXILIARES DE VARIAVEIS DO DOMINIO %%%%%%%
...
escola_de_linguas(Professores, Candidaturas, Linguas, Salas, Lucro, Solucao):-
	...
	generate_days_prof_table(Solucao, Dias),nl,nl, write(Dias),nl, nl,
	generate_variable_domain_list(Solucao, H, P),
	%restrict_rooms(Dias, Salas, NLinguas),
...
%	escola_de_linguas([[0, [0-10,1-10],[0,1]], [1, [0-5,2-1],[0,1]],[2, [0-5],[0,1]],[2, [0-5,2-1],[0,1]],[2, [0-5],[0,1]],[3, [3-5,4-1],[0,1]],[4, [4-5],[0,1]]], [0-10,1-10,2-10,3-10,4-10], [0-20,1-40,2-10,3-10,4-10], 2, Lucro, Solucao),
